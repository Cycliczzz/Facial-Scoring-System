...
function createFrontNorms(
  ...
  const defaults: MeasurementNorms = {
    ...
    cheekbone_height: base.cheekbone_height ?? { min: 45, max: 65, ideal: 55, description: "Percentage ratio of cheekbone height to pupil line height" },
    ...
    mouth_corner_position: base.mouth_corner_position ?? { min: 0, max: 5, ideal: 2, description: "Average vertical offset of mouth corners from mouth middle line in mm" },
    ...
    interpupillary_mouth_width: base.interpupillary_mouth_width ?? { min: 0.85, max: 1.05, ideal: 0.95, description: "Ratio of mouth width to interpupillary distance" },
    ...
    one_eye_apart: base.one_eye_apart ?? { min: 0.90, max: 1.15, ideal: 1.00, description: "Ratio of intercanthal distance to average eyelid hood distance" },
...
export const FRONT_IDEALS: Record<Gender, Record<Ethnicity, MeasurementNorms>> = {
  male: {
    asian: createFrontNorms({
      ...
      bitemporal_width: { min: 75, max: 88, ideal: 82, description: "Ratio of bitemporal width to facial width" },
      cheekbone_height: { min: 45, max: 58, ideal: 52, description: "Ratio of cheekbone height to facial height" },
      bigonial_width: { min: 70, max: 85, ideal: 78, description: "Ratio of bigonial width to bizygomatic width" },
      jaw_slope: { min: 55, max: 75, ideal: 65, description: "Angle of jaw line relative to horizontal" },
      eye_aspect_ratio: { min: 2.0, max: 4.0, ideal: 3.0, description: "Ratio of eye width to eye height" },
      eye_separation_ratio: { min: 42, max: 52, ideal: 47, description: "Percentage ratio of interpupillary distance to facial width" },
      face_width_to_height: { min: 0.75, max: 0.88, ideal: 0.82, description: "Ratio of facial width to facial height" },
      jaw_frontal_angle: { min: 100, max: 140, ideal: 120, description: "Angle between left and right lower jaw-to-chin lines" },
      ipsilateral_alar_angle: { min: 25, max: 40, ideal: 32, description: "Angle at nasal base between left and right eyelid hood ends" },
      mouth_width_to_nose_width: { min: 1.30, max: 1.70, ideal: 1.50, description: "Ratio of mouth width to nose width" },
      total_facial_width_to_height: { min: 1.15, max: 1.40, ideal: 1.28, description: "Ratio of facial height to bizygomatic width" },
      chin_to_philtrum: { min: 1.80, max: 2.40, ideal: 2.10, description: "Ratio of chin height to philtrum height" },
      eyebrow_low_setedness: { min: 0.12, max: 0.22, ideal: 0.17, description: "Ratio of brow-to-pupil distance to eye height" },
      brow_length_to_face_width: { min: 0.28, max: 0.38, ideal: 0.33, description: "Ratio of brow length to facial width" },
      lower_third_proportion: { min: 30, max: 40, ideal: 36, description: "Proportion of lower third" },
    }),
...
export const FRONT_MEASUREMENTS_META: MeasurementMeta[] = [
  ...
  { id: "interpupillary_mouth_width", name: "Interpupillary-Mouth Width Ratio", unit: "ratio", category: "Proportions", description: "Ratio of mouth width to interpupillary distance" },
