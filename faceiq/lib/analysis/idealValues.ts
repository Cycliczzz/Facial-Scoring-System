...
function createFrontNorms(
  ...
  const defaults: MeasurementNorms = {
    ...
    bitemporal_width: base.bitemporal_width ?? { min: 0.75, max: 0.88, ideal: 0.82, description: "Ratio of bitemporal width to facial width" },
    neck_width: base.neck_width ?? { min: 0.55, max: 0.70, ideal: 0.62, description: "Ratio of neck width to facial width" },
    ear_protrusion_angle: base.ear_protrusion_angle ?? { min: 15, max: 30, ideal: 22, description: "Angle of ear protrusion from the head" },
    cheekbone_height: base.cheekbone_height ?? { min: 0.45, max: 0.58, ideal: 0.52, description: "Ratio of cheekbone height to facial height" },
    cupids_bow_depth: base.cupids_bow_depth ?? { min: 2, max: 5, ideal: 3.5, description: "Depth of Cupid's bow in mm" },
    bigonial_width: base.bigonial_width ?? { min: 0.70, max: 0.85, ideal: 0.78, description: "Ratio of bigonial width to bizygomatic width" },
    jaw_slope: base.jaw_slope ?? { min: 55, max: 75, ideal: 65, description: "Angle of jaw line relative to horizontal" },
    ear_protrusion_ratio: base.ear_protrusion_ratio ?? { min: 0.08, max: 0.15, ideal: 0.11, description: "Ratio of ear protrusion to head length" },
    middle_third: base.middle_third ?? { min: 0.30, max: 0.38, ideal: 0.34, description: "Ratio of middle facial third to total facial height" },
    eye_aspect_ratio: base.eye_aspect_ratio ?? { min: 0.30, max: 0.45, ideal: 0.38, description: "Ratio of eye height to eye width" },
    mouth_corner_position: base.mouth_corner_position ?? { min: 0.40, max: 0.55, ideal: 0.48, description: "Vertical position of mouth corners" },
    eye_separation_ratio: base.eye_separation_ratio ?? { min: 0.42, max: 0.52, ideal: 0.47, description: "Ratio of intercanthal distance to facial width" },
    eyebrow_tilt: base.eyebrow_tilt ?? { min: 5, max: 15, ideal: 10, description: "Angle of eyebrow tilt from medial to lateral" },
    lower_third: base.lower_third ?? { min: 0.32, max: 0.40, ideal: 0.36, description: "Ratio of lower facial third to total facial height" },
    face_width_to_height: base.face_width_to_height ?? { min: 0.75, max: 0.88, ideal: 0.82, description: "Ratio of facial width to facial height" },
    interpupillary_mouth_width: base.interpupillary_mouth_width ?? { min: 0.85, max: 1.05, ideal: 0.95, description: "Ratio of interpupillary distance to mouth width" },
    jaw_frontal_angle: base.jaw_frontal_angle ?? { min: 100, max: 125, ideal: 112, description: "Angle of jaw at gonion in frontal view" },
    intercanthal_nasal_width: base.intercanthal_nasal_width ?? { min: 0.90, max: 1.10, ideal: 1.00, description: "Ratio of intercanthal distance to nasal width" },
    top_third: base.top_third ?? { min: 0.28, max: 0.36, ideal: 0.32, description: "Ratio of upper facial third to total facial height" },
    one_eye_apart: base.one_eye_apart ?? { min: 0.90, max: 1.15, ideal: 1.00, description: "Ratio of interpupillary distance to one eye width" },
    midface_ratio: base.midface_ratio ?? { min: 0.95, max: 1.10, ideal: 1.02, description: "Ratio of midface width to midface height" },
    ipsilateral_alar_angle: base.ipsilateral_alar_angle ?? { min: 25, max: 40, ideal: 32, description: "Angle of alar base on one side relative to midline" },
    ...
    total_facial_width_to_height: base.total_facial_width_to_height ?? { min: 0.72, max: 0.85, ideal: 0.78, description: "Ratio of total facial width to total facial height" },
    chin_to_philtrum: base.chin_to_philtrum ?? { min: 1.80, max: 2.40, ideal: 2.10, description: "Ratio of chin height to philtrum height" },
    eyebrow_low_setedness: base.eyebrow_low_setedness ?? { min: 0.12, max: 0.22, ideal: 0.17, description: "Distance from brow to eye as ratio of facial height" },
    brow_length_to_face_width: base.brow_length_to_face_width ?? { min: 0.28, max: 0.38, ideal: 0.33, description: "Ratio of brow length to facial width" },
    nose_tip_position: base.nose_tip_position ?? { min: 0.55, max: 0.70, ideal: 0.62, description: "Vertical position of nose tip relative to face" },
    deviation_iaa_jfa: base.deviation_iaa_jfa ?? { min: 0, max: 8, ideal: 3, description: "Deviation between ipsilateral alar angle and jaw frontal angle" },
    ...
    lower_third_proportion: base.lower_third_proportion ?? { min: 0.32, max: 0.40, ideal: 0.36, description: "Proportion of lower third of face" },
  }
  return defaults
}
...
function createSideNorms(
  ...
  const defaults: MeasurementNorms = {
    ...
    anterior_facial_depth: base.anterior_facial_depth ?? { min: 0.85, max: 1.00, ideal: 0.92, description: "Ratio of anterior facial depth to facial height" },
...
export const FRONT_IDEALS: Record<Gender, Record<Ethnicity, MeasurementNorms>> = {
  male: {
    asian: createFrontNorms({
      ...
      nose_bridge_to_width: { min: 0.55, max: 0.75, ideal: 0.65, description: "Ratio of nose bridge width to nose width" },
      bitemporal_width: { min: 0.75, max: 0.88, ideal: 0.82, description: "Ratio of bitemporal width to facial width" },
      neck_width: { min: 0.55, max: 0.70, ideal: 0.62, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 15, max: 30, ideal: 22, description: "Angle of ear protrusion from the head" },
      ...
      jaw_slope: { min: 55, max: 75, ideal: 65, description: "Angle of jaw line relative to horizontal" },
      eye_aspect_ratio: { min: 0.30, max: 0.45, ideal: 0.38, description: "Ratio of eye height to eye width" },
      eye_separation_ratio: { min: 0.42, max: 0.52, ideal: 0.47, description: "Ratio of intercanthal distance to facial width" },
      face_width_to_height: { min: 0.75, max: 0.88, ideal: 0.82, description: "Ratio of facial width to facial height" },
      jaw_frontal_angle: { min: 100, max: 125, ideal: 112, description: "Angle of jaw at gonion in frontal view" },
      ipsilateral_alar_angle: { min: 25, max: 40, ideal: 32, description: "Angle of alar base on one side" },
      ...
      eyebrow_low_setedness: { min: 0.12, max: 0.22, ideal: 0.17, description: "Distance from brow to eye as ratio" },
      brow_length_to_face_width: { min: 0.28, max: 0.38, ideal: 0.33, description: "Ratio of brow length to facial width" },
      lower_third_proportion: { min: 0.32, max: 0.40, ideal: 0.36, description: "Proportion of lower third" },
    }),
    caucasian: createFrontNorms({
      ...
      bitemporal_width: { min: 0.78, max: 0.90, ideal: 0.84, description: "Ratio of bitemporal width to facial width" },
      neck_width: { min: 0.52, max: 0.68, ideal: 0.60, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 18, max: 32, ideal: 25, description: "Angle of ear protrusion from the head" },
    ...
    black: createFrontNorms({
      ...
      neck_width: { min: 0.55, max: 0.72, ideal: 0.63, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 15, max: 28, ideal: 21, description: "Angle of ear protrusion" },
      cheekbone_height: { min: 0.45, max: 0.58, ideal: 0.52, description: "Ratio of cheekbone height to facial height" },
      ...
      face_width_to_height: { min: 0.75, max: 0.88, ideal: 0.82, description: "Ratio of facial width to facial height" },
      interpupillary_mouth_width: { min: 0.80, max: 1.00, ideal: 0.90, description: "Ratio of interpupillary distance to mouth width" },
    ...
    hispanic: createFrontNorms({
      ...
      neck_width: { min: 0.53, max: 0.70, ideal: 0.61, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 16, max: 30, ideal: 23, description: "Angle of ear protrusion" },
    ...
    middle_eastern: createFrontNorms({
      ...
      neck_width: { min: 0.54, max: 0.70, ideal: 0.62, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 17, max: 30, ideal: 23, description: "Angle of ear protrusion" },
  ...
  female: {
    asian: createFrontNorms({
      ...
      neck_width: { min: 0.50, max: 0.65, ideal: 0.58, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 15, max: 28, ideal: 21, description: "Angle of ear protrusion" },
      ...
      ear_protrusion_ratio: { min: 0.08, max: 0.15, ideal: 0.11, description: "Ratio of ear protrusion to head length" },
      ...
      interpupillary_mouth_width: { min: 0.85, max: 1.05, ideal: 0.95, description: "Ratio of interpupillary distance to mouth width" },
    ...
    caucasian: createFrontNorms({
      ...
      nose_bridge_to_width: { min: 0.48, max: 0.68, ideal: 0.58, description: "Ratio of nose bridge width to nose width" },
      bitemporal_width: { min: 0.75, max: 0.88, ideal: 0.82, description: "Ratio of bitemporal width to facial width" },
      neck_width: { min: 0.48, max: 0.62, ideal: 0.55, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 18, max: 30, ideal: 24, description: "Angle of ear protrusion" },
    ...
    black: createFrontNorms({
      ...
      neck_width: { min: 0.50, max: 0.68, ideal: 0.59, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 14, max: 26, ideal: 20, description: "Angle of ear protrusion" },
      cheekbone_height: { min: 0.43, max: 0.56, ideal: 0.50, description: "Ratio of cheekbone height to facial height" },
      ...
      face_width_to_height: { min: 0.72, max: 0.85, ideal: 0.78, description: "Ratio of facial width to facial height" },
      interpupillary_mouth_width: { min: 0.78, max: 0.98, ideal: 0.88, description: "Ratio of interpupillary distance to mouth width" },
    ...
    hispanic: createFrontNorms({
      ...
      neck_width: { min: 0.49, max: 0.64, ideal: 0.56, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 16, max: 28, ideal: 22, description: "Angle of ear protrusion" },
      cheekbone_height: { min: 0.42, max: 0.55, ideal: 0.48, description: "Ratio of cheekbone height to facial height" },
    ...
    middle_eastern: createFrontNorms({
      ...
      neck_width: { min: 0.50, max: 0.65, ideal: 0.57, description: "Ratio of neck width to facial width" },
      ear_protrusion_angle: { min: 17, max: 28, ideal: 22, description: "Angle of ear protrusion" },
...
export const FRONT_MEASUREMENTS_META: MeasurementMeta[] = [
  ...
  { id: "bitemporal_width", name: "Bitemporal Width", unit: "ratio", category: "Head", description: "Ratio of bitemporal width to facial width" },
  { id: "neck_width", name: "Neck Width", unit: "ratio", category: "Neck", description: "Ratio of neck width to facial width" },
  { id: "ear_protrusion_angle", name: "Ear Protrusion Angle", unit: "degrees", category: "Ears", description: "Angle of ear protrusion from the head" },
  { id: "cheekbone_height", name: "Cheekbone Height", unit: "ratio", category: "Cheeks", description: "Ratio of cheekbone height to facial height" },
  { id: "cupids_bow_depth", name: "Cupid's Bow Depth", unit: "mm", category: "Mouth", description: "Depth of Cupid's bow curvature" },
  { id: "bigonial_width", name: "Bigonial Width", unit: "ratio", category: "Jaw", description: "Ratio of bigonial width to bizygomatic width" },
  { id: "jaw_slope", name: "Jaw Slope", unit: "degrees", category: "Jaw", description: "Angle of jaw line relative to horizontal" },
  { id: "ear_protrusion_ratio", name: "Ear Protrusion Ratio", unit: "ratio", category: "Ears", description: "Ratio of ear protrusion to head length" },
  { id: "middle_third", name: "Middle Third", unit: "ratio", category: "Proportions", description: "Ratio of middle facial third to total facial height" },
  { id: "eye_aspect_ratio", name: "Eye Aspect Ratio", unit: "ratio", category: "Eyes", description: "Ratio of eye height to eye width" },
  { id: "mouth_corner_position", name: "Mouth Corner Position", unit: "ratio", category: "Mouth", description: "Vertical position of mouth corners" },
  { id: "eye_separation_ratio", name: "Eye Separation Ratio", unit: "ratio", category: "Eyes", description: "Ratio of intercanthal distance to facial width" },
  { id: "eyebrow_tilt", name: "Eyebrow Tilt", unit: "degrees", category: "Brows", description: "Angle of eyebrow tilt from medial to lateral" },
  { id: "lower_third", name: "Lower Third", unit: "ratio", category: "Proportions", description: "Ratio of lower facial third to total facial height" },
  { id: "face_width_to_height", name: "Face Width to Height Ratio", unit: "ratio", category: "Proportions", description: "Ratio of facial width to facial height" },
  { id: "interpupillary_mouth_width", name: "Interpupillary-Mouth Width Ratio", unit: "ratio", category: "Proportions", description: "Ratio of interpupillary distance to mouth width" },
  { id: "jaw_frontal_angle", name: "Jaw Frontal Angle", unit: "degrees", category: "Jaw", description: "Angle of jaw at gonion in frontal view" },
  { id: "intercanthal_nasal_width", name: "Intercanthal-Nasal Width Ratio", unit: "ratio", category: "Nose", description: "Ratio of intercanthal distance to nasal width" },
  { id: "top_third", name: "Top Third", unit: "ratio", category: "Proportions", description: "Ratio of upper facial third to total facial height" },
  { id: "one_eye_apart", name: "One Eye Apart Test", unit: "ratio", category: "Eyes", description: "Ratio of interpupillary distance to one eye width" },
  { id: "midface_ratio", name: "Midface Ratio", unit: "ratio", category: "Proportions", description: "Ratio of midface width to midface height" },
  { id: "ipsilateral_alar_angle", name: "Ipsilateral Alar Angle", unit: "degrees", category: "Nose", description: "Angle of alar base on one side relative to midline" },
  ...
  { id: "total_facial_width_to_height", name: "Total Facial Width to Height Ratio", unit: "ratio", category: "Proportions", description: "Ratio of total facial width to total facial height" },
  { id: "chin_to_philtrum", name: "Chin to Philtrum Ratio", unit: "ratio", category: "Chin", description: "Ratio of chin height to philtrum height" },
  { id: "eyebrow_low_setedness", name: "Eyebrow Low Setedness", unit: "ratio", category: "Brows", description: "Distance from brow to eye as ratio of facial height" },
  { id: "brow_length_to_face_width", name: "Brow Length to Face Width Ratio", unit: "ratio", category: "Brows", description: "Ratio of brow length to facial width" },
  { id: "nose_tip_position", name: "Nose Tip Position", unit: "ratio", category: "Nose", description: "Vertical position of nose tip relative to face" },
  { id: "deviation_iaa_jfa", name: "Deviation of IAA & JFA", unit: "degrees", category: "Nose", description: "Deviation between ipsilateral alar angle and jaw frontal angle" },
  ...
  { id: "lower_third_proportion", name: "Lower Third Proportion", unit: "ratio", category: "Proportions", description: "Proportion of lower third of face" },
]
...
export const SIDE_MEASUREMENTS_META: MeasurementMeta[] = [
  ...
  { id: "nasal_projection", name: "Nasal Projection", unit: "ratio", category: "Nose", description: "Ratio of nasal projection to nasal length" },
  ...
  { id: "anterior_facial_depth", name: "Anterior Facial Depth", unit: "ratio", category: "Proportions", description: "Ratio of anterior facial depth to facial height" },
