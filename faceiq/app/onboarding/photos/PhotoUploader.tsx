...
export function PhotoUploader({ initialGender = "male", initialEthnicity }: PhotoUploaderProps) {
  ...
  const handleUpload = async () => {
    if (!file) {
      setError("Please select a front profile photo before continuing.")
      return
    }
    ...
    try {
      ...
      // After successfully saving the front profile, move to the side profile step
  ...
  const handleBack = () => {
    const genderQuery = initialGender ?? "male"
    router.push(`/onboarding/ethnicity?gender=${genderQuery}`)
  }
    ...
    <div className="space-y-6">
      <div className="space-y-1 text-center">
        <h2 className="text-2xl font-semibold tracking-tight text-sky-100 sm:text-3xl">
          Upload your front profile
        </h2>
        <p className="text-xs text-muted-foreground sm:text-sm">
          A clear, front-facing photo helps us analyse your facial harmony accurately.
        </p>
      </div>
          ...
          <div className="relative flex flex-col items-center gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="mt-1 text-[11px] text-muted-foreground">
                JPG or PNG · Max 10MB · Face fully visible, good lighting, no heavy filters.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-1 text-xs text-muted-foreground">
                ...
                <ul className="list-disc space-y-1 pl-4">
                  ...
                  <li>Keep your entire face visible (no hair covering key areas).</li>
          ...
          {success && (
            <div className="flex items-center gap-2 rounded-xl border border-emerald-500/40 bg-emerald-500/10 px-3 py-2 text-xs text-emerald-100">
              ...
              <span>Your photo is saved. You can continue to the next step.</span>
            </div>
          )}
