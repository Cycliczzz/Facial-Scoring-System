...
import { LandmarkPlacer } from "../front-landmarks/LandmarkPlacer"

interface SideLandmarksPageProps {
...
export default async function SideLandmarksPage({ searchParams }: SideLandmarksPageProps) {
